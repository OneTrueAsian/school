...
void VecTester::testWriteToFile() const {
 ...
 void VecTester::testSetIndex() const {
     cout << "Testing operator[]... " << flush;
     // empty Vec
     Vec v0;
     try {
         v0[0];
         cerr << "testGeti succeeded on empty Vec";
         exit(1);
     } catch (range_error&) {
         cout << " 0 " << flush;
     }
     ...
     try {
         v2[6];
         cerr << "testSeti succeeded beyond end of Vec";
         exit(1);
     } catch (range_error&) {
         cout << " 2 " << flush;
     }
 ...
 void VecTester::testGetIndex() const {
     cout << "Testing const operator[]()... " << flush;
     // empty Vec
     Vec v0;
     try {
         v0[0];
